...
#database.path <-  "C:\\Users\\olsen\\Desktop\\Cell Profiler\\P36_BG_d7\\P36_BG_d7_v6_2.db"
```
...
#cyto_path <- "C:\\Users\\olsen\\Desktop\\Batch_6\\batch_6_cyto_new.csv"
#double_path <- "C:\\Users\\olsen\\Desktop\\Batch_6\\batch_6_double_new.csv" 
}
```
...
#image.data <- image.data[c("Image_Metadata_Plate","Image_Metadata_Well","Image_Count_TotalCells","Image_Count_RelateObjectsTxRd", "Image_Count_cytoDDX4","Image_Count_cytoDDX4_EdU")]
somatic <- image.data[c("Image_Metadata_Plate","Image_Metadata_Well","Image_Count_Filtered_nuclei")]
txrd <- image.data[c("Image_Metadata_Plate","Image_Metadata_Well","Image_Count_Filtered_DDX4")]
...
cyto[cyto[,3]<double[,3],3] <- double[cyto[,3]<double[,3],3]
txrd[txrd[,3] < cyto[,3],3] <- cyto[txrd[,3] < cyto[,3],3]
...
txrd <- apply_plate(a=txrd,b="Image_Metadata_Plate",d=sum_well, c="Image_Metadata_Well", e=c("Metadata_Plate","Metadata_Well","Count_txrd"), f = "Image_Count_Filtered_DDX4")
