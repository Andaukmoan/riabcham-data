...
ilastik_project_DDX4 = 'C:/Users/olsen/Desktop/DDX4_EdU_pipeline_v6.1/DDX4_segmentation_v2_3.ilp'
#Get all files in selected folder 
...
if __name__ == "__main__":    
    ...
    a.join()
    os.chdir(start_dir)
    print("Finished DDX4 segmentation")
